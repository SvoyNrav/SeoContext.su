          ...
          <div class="container">
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <!-- ABOUT TITLE -->
                  <h3 class="anim-from-left">Разработка сайтов</h3>
                  
                  <!-- ABOUT DESCRIPTION -->
                  <p class="anim-from-left">Студия SeoContext делает эффективные сайты практически с начала самого существования рунета. Наша специализация — профессиональная разработка сайтов под ключ, предназначенных прежде всего для зарабатывания денег и привлечения клиентов. Поэтому мы не просто делаем дизайн, вёрстку и программирование, а комплексно разрабатываем сайт с учётом огромного количества подводных камней и многочисленных «фишек», которые помогут вам зацепить своего клиента и продавать свои услуги.</p>
                  <p class="anim-from-left">Каждому своему клиенту мы гарантируем высокое качество исполнения его проекта, и отличный результат, выраженный в хорошей посещаемости, солидной конверсии и, в конечном итоге, в продажах! В своей работе мы широко используем специалистов-фрилансеров из регионов и ближнего зарубежья, что позволяет значительно экономить, снижая стоимость разработки сайта и Москва не сделает его цену заоблачной.</p>
          ...
          <div class="container">
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <!-- ABOUT TITLE -->
                  <h3 class="anim-from-right">Продвижение</h3>
                  
                  <!-- ABOUT DESCRIPTION -->
                  <p class="anim-from-right">Раскрутка сайта — предметная область, в которой ежедневно работает вся наша команда, является для нас изученной на практике средой, вместе со своими особенностями, постоянными изменениями и динамикой. Продвижение сайтов — наше ремесло. </p>
                  <p class="anim-from-right">Сегодня, по заявлениям самой поисковой системы, в Яндексе применяется 800 факторов ранжирования сайтов, и для получения гарантированных результатов мы должны их понимать и уметь с ними работать. Все накопленные знания мы используем для раскрутки вашего сайта. В этом и заключается наша уникальность на рынке SEO — развитие в едином фокусе поисковой оптимизации. Причем продвижение сайтов всегда выполняется грамотно и профессионально.</p>
